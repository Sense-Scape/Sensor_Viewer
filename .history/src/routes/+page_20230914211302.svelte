<script lang="ts">
	...
	function updateChart(newData) {
		myChart.data.datasets.forEach((dataset, index) => {
			dataset.data.push(newData[index]); // Push new data points to each dataset
		});

		// Add a new label for the x-axis (assuming you have a time-based x-axis)
		myChart.data.labels.push(newXValue);

		// Remove the first data point to maintain a constant number of data points
